...
type tx_catcher_statistic_data_job struct {}


func (j tx_catcher_statistic_data_job) RequestData(ctx *base.FinDataCatcherJobContext)  (string, error)	{
...
func (j tx_catcher_statistic_data_job) ProcessResponse(ctx *base.FinDataCatcherJobContext, resp string) bool {
	//ctx
